...
<head>
    ...
    <body>
        ...
        <?php foreach ($commentaire as $commentaire): ?> <!-- à chaque itération on récupére un utilisateur -->
            ...
            <li>
            <?= $commentaire['utilisateur_id'] ?> <?= $commentaire['description'] ?> 
            
                <a href ="supprimer.php?numUtilisateur=<?= $commentaire['utilisateur_id']?>"> Supprimer </a>
