<?php
    ...
    try{
        ...
        $PDOStat = $objectPDO->prepare('DELETE FROM utilisateur WHERE id=:num LIMIT 1'); //on utilise le paramètre num et le limite à 1 à la fois
        ...
        if($deleteIsOk){
            ...
            $message = "Echec lors de la suppression de l'utilisateur";
        }
    }
